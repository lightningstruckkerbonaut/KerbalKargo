...
Right now it's in a development state, but there is compatibility with EPL, and it should be compatible with TAC LS, Kerbalism and Snacks (B9 subtypes with resources from those mods only if you have them installed)
